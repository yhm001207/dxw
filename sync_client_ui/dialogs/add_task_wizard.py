...
class AddTaskDialog(QDialog):
    ...
    def _build_page2(self):
        ...
        self._retention_spin.setRange(1, 36500)
        self._retention_spin.setValue(7)
        self._retention_spin.setSuffix(' 天')
        self._retention_spin.setMinimumHeight(36)
        self._retention_spin.setToolTip('超过此天数的旧版本会被自动清理，设大即保留更久')
        form.addRow('版本保留:', self._retention_spin)
    ...
    def _update_summary(self):
        ...
        self._summary.setText(
            ...
            f'版本保留: {self._retention_spin.value()} 天\n'
            f'冲突策略: {conflict_labels[self._conflict_combo.currentIndex()]}'
        )
